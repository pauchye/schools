...
class SchoolDetail extends React.Component {
  render() {
    ...
    const isCompared = compareDbns.indexOf(dbn) >= 0
    const isSaved = savedDbns.indexOf(dbn) >= 0
      ...
      <div className="detail-page">
        ...
        <div className="detail-heading">
          ...
          <div className="detail-actions">
            <span className="btn" onClick={() => toggleSaved(dbn)}>{isSaved ? 'Saved' : 'Save'}</span>
            <span className={`btn btn-dark${isCompared ? ' is-active' : ''}`} onClick={() => toggleCompare(dbn)}>
